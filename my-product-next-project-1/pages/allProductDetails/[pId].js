      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{myData.title}</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">Product information</h2>
            <p className="text-3xl tracking-tight text-gray-900">{"$" +myData.price}</p>
          ...
          <div className="py-10 px-10  lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6 bg-gray-300">
            ...
            <div className="mt-10">
              <h3 className="text-lg font-medium text-gray-900">DiscountPercentage</h3>

              <div className="mt-4">
                <ul role="list" className="list-disc space-y-2 pl-2 text-sm">
                 <span>{myData.discountPercentage}</span>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <ul role="list" className="list-disc space-y-2 pl-2 text-sm">
                <span className="text-sm text-gray-600">{myData.rating}</span>
                </ul>
            </div>
            <div className="mt-10">
              <h2 className="text-lg font-medium text-gray-900">Brand</h2>
              <ul role="list" className="list-disc space-y-2 pl-2 text-sm">
                <span className="text-sm text-gray-600">{myData.brand}</span>
                </ul>
            </div>
            <div className="mt-10">
              <h2 className="text-lg font-medium text-gray-900">Category</h2>
              <ul role="list" className="list-disc space-y-2 pl-2 text-sm">
                <span className="text-sm text-gray-600">{myData.category}</span>
                </ul>
            </div>
            <div className="mt-10">
...
export async function getStaticPaths() {
  const res = await fetch("http://localhost:3002/api/AllProducts/");
...
export async function getStaticProps(context) {
  ...
  // console.log(params);
  const res = await fetch(`http://localhost:3002/api/AllProducts/${params.pId}`);
  const data = await res.json();
